		...
		for e in range(self.args.num_epochs):
			...
			if len(self.splitter.test)>0 and eval_valid==best_eval_valid and e>self.args.eval_after_epochs:
				...
				if self.args.save_state:
					state = {"epoch":e, "gcn_dict":self.gcn.GRCU_layers.state_dict(), "classifier_dict":self.classifier.state_dict(), "gcn_optimizer":self.gcn_opt, "classifier_optimizer":self.classifier_opt}
